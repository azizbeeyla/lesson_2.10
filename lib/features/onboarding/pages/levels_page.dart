...
class LevelsContainer extends StatefulWidget {
  const LevelsContainer({super.key});

  @override
  State<LevelsContainer> createState() => _LevelsContainerState();
}

class _LevelsContainerState extends State<LevelsContainer> {
  int selectedIndex = -1;
